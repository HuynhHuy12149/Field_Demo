...
import { UserResponse } from "@/core/services/tenant/users.service";
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48 bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
            ...
            <DropdownMenuItem onClick={() => onDelete(user.id)} className="cursor-pointer text-red-600 focus:text-red-600 focus:bg-red-50 dark:focus:bg-red-900/20">
